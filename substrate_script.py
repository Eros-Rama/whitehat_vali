...
# if x:
    extrinsic_netuid = extrinsic_address = extrinsic_hash = extrinsic_call = None
    # extrinsic_events = []
    ...
    if hasattr(extrinsic, 'value'):
        ...
        if 'call' in extrinsic:
            extrinsic_call = extrinsic['call']
        # print(extrinsic_call)
            call_args = extrinsic['call']['call_args']
    ...
    Extrinsic.objects.create(
        ...
        extrinsic_netuid=extrinsic_netuid,
        extrinsic_address = extrinsic_address,
        extrinsic_block = block_number,
